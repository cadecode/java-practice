package com.github.cadecode.learn.tibrv.example;/*
...
public class sendobject implements TibrvMsgCallback {
    ...
    public sendobject(String[] args) {
        ...
        try {
            ...
            TibrvRvdTransport tport = new TibrvRvdTransport(service, network, daemon);
    ...
    void usage() {
        System.err.println("Usage: java sendobject [-service service] [-network network]");
